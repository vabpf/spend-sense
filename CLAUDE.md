...
This project is indexed by GitNexus as **spend-sense** (1584 symbols, 3355 relationships, 67 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
